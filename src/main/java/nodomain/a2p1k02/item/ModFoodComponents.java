...
public class ModFoodComponents {
    ...
    public static final FoodComponent VEGETABLE_COMPONENT = new FoodComponent.Builder().nutrition(2).saturationModifier(0.25f).build();
    public static final FoodComponent SOUP_COMPONENT = new FoodComponent.Builder().nutrition(2).saturationModifier(0.25f).build();
    public static final FoodComponent BEEF_COMPONENT = new FoodComponent.Builder().nutrition(3).saturationModifier(0.25f).build();
    public static final FoodComponent COOKED_BEEF_COMPONENT = new FoodComponent.Builder().nutrition(8).saturationModifier(0.25f).build();
